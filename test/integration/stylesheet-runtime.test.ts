...
describe('stylesheet runtime integration', () => {
  ...
  it('inline attributes override stylesheet values', async () => {
  ...
  it('end-to-end: stylesheet sets simulation provider, validation accepts it', async () => {
    const graph = parseGardenSource(`digraph G {
  ...
  it('specificity: id > class > shape > universal', async () => {
    const graph = parseGardenSource(`digraph G {
  ...
  it('stylesheet syntax error produces STYLESHEET_SYNTAX diagnostic in validation', async () => {
    const graph = parseGardenSource(`digraph G {
